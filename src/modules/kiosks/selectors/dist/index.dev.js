...
var getAlertsOptions = function getAlertsOptions() {
  return [
    ...
    _toConsumableArray(
      Object.keys(alertMessages).map(function(alert) {
        return {
          value: alert,
...
var getKioskShelves = (0, _reselect.createSelector)(getKioskSingle, function(
  kiosk,
) {
  var cells = (0, _get2['default'])(kiosk, 'inventory.loadCells', []);
  var loadCells = (0, _sortBy['default'])(cells, 'productLine.name').reduce(
    function(prev, _ref) {
...
var getKiosksAlerts = (0, _reselect.createSelector)(getKiosksState, function(
  kiosks,
) {
  var filteredTempKiosks = kiosks
  ...
  var filteredOfflineKiosks = kiosks
  ...
  return [].concat(
    _toConsumableArray(filteredTempKiosks),
    _toConsumableArray(filteredOfflineKiosks),
  );
});
exports.getKiosksAlerts = getKiosksAlerts;
var getKiosksAlertsForTable = (0, _reselect.createSelector)(
  [getKiosksAlertsState],
  function(alerts) {
    return alerts.map(function(alert) {
      return _objectSpread({}, alert, {
        startDate: (0, _format['default'])(
...
var getAlmostEmptyKiosksForTable = (0, _reselect.createSelector)(
  [getAlmostEmptyKiosks],
  function(kiosks) {
    if (kiosks && kiosks.length > 0) {
      return kiosks.map(function(kiosk) {
        return {
          product: (0, _get2['default'])(
            kiosk,
            'inventory.loadCells.productLine.name',
            'unknown',
          ),
          scale: (0, _get2['default'])(
            kiosk,
            'inventory.loadCells.cellId',
            'unknown',
          ),
...
var getKiosksAlertsDashboard = (0, _reselect.createSelector)(
  getKiosksState,
  function(kiosks) {
...
var getKioskListName = (0, _reselect.createSelector)(getKiosksState, function(
  kiosks,
) {
...
var getKioskOptions = (0, _reselect.createSelector)(getKiosksState, function(
  kiosks,
) {
  return [
    {
...
var getKioskOptionsForTableDropdown = (0, _reselect.createSelector)(
  getKiosksState,
  function(kiosks) {
...
var getKioskInitValues = (0, _reselect.createSelector)(getKioskSingle, function(
  kiosk,
) {
  var _get = (0, _get2['default'])(
      kiosk,
      'location.address',
...
var getOrgIdFromKiosk = (0, _reselect.createSelector)(getKioskSingle, function(
  kiosk,
) {
...
var getTemperatureLogsState = function getTemperatureLogsState(state) {
  ...
  return logs.map(function(log) {
    ...
    return {
      ...
      day: isAllMonthsSame
        ? log.day
        : ''.concat(monthNames[log.month], '/').concat(log.day),
