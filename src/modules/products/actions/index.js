...
export const getDefaultProductLinePriceHistory = createAction(
  '@@state/GET_DEFAULT_PRODUCTLINE_PRICE_HISTORY',
);
export const getDefaultProductLinePriceHistorySuccess = createAction(
  '@@state/GET_DEFAULT_PRODUCTLINE_PRICE_HISTORY_SUCCESS',
);
export const getProductLineActivePriceHistory = createAction(
  '@@state/GET_PRODUCTLINE_ACTIVE_PRICE_HISTORY',
);
export const getProductLineActivePriceHistorySuccess = createAction(
  '@@state/GET_PRODUCTLINE_ACTIVE_PRICE_HISTORY_SUCCESS',
);
