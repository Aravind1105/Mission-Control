...
import { Mail, Menu, MoreVertical, Bell, User, Search, Inbox, Phone, Calendar, Lock, X, LogOut } from 'react-feather';
import ReactCountryFlag from 'react-country-flag';

import avtarImg from '../../assets/img/photos/2880x1800-light-sea-green-solid-color-background.jpg';

import { authRemoveUserDetails } from '../../_actions';
            ...
            <Collapse isOpen={this.state.isOpen} navbar>
              <Nav className="ml-auto float-right" navbar>
                ...
                <UncontrolledDropdown nav inNavbar className="pr-1">
                  <DropdownToggle nav>
                    <img
                      src={userProfile.hasOwnProperty('picture') ? userProfile.picture : avtarImg}
                      alt="logged-in-user"
