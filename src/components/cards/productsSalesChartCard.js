      ...
      <Card>
        ...
        <CardBody className="pt-2 pb-0">
          <div className="chart-info mb-2">
            <span className="gradient-blackberry d-inline-block rounded-circle mr-1 p-1"> </span>
            {this.props.salesText}
            <span className="gradient-mint d-inline-block rounded-circle mr-1 ml-2 p-1"> </span>
