...
import { Card, CardHeader, CardTitle, CardBody, Media, FormGroup, Label, Input, Button } from 'reactstrap';
              ...
              <div key={i}>
                {[
                  <Media className="mb-1" key={i}>
                    ...
                    <Media body>
                      <h4 className="font-medium-1 mt-1 mb-0">{object.fullName}</h4>
                      <p className="text-muted font-small-3">{object.position}</p>
                    </Media>
                    <FormGroup check>
                      <Label check>
                        <Input type="checkbox" />
