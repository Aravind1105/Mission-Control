          ...
          <Row className="d-flex mb-3 py-2">
            <Col sm="12" className="text-center">
              <img
                ...
                alt="Card cap 02"
              />
              <h3 className="font-large-1 text-center">{this.props.fullName}</h3>
              <span className="font-medium-1 grey d-block text-center">{this.props.department}</span>
            </Col>
          </Row>
          <Row className="mt-4 mb-3">
            ...
            <Col sm="5">
              <span className="font-large-1">
                <Icon.ArrowUpCircle size={20} strokeWidth="1.6" className="success" /> 27%
              </span>
            </Col>
          </Row>
        </CardBody>
