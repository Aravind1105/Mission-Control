    ...
    <React.Fragment>
      <Form
        onSubmit={e => {
          ...
          dispatch(
            addProduct(id, name.value, description.value, price.value, individualWeight.value, packagingWeight.value),
          );
          name.value = '';
          description.value = '';
          price.value = '';
      ...
      >
        <ModalBody>
          <Row>
            <Col md={6}>
              <img src={backgroundImg} className="rounded-circle width-100 height-100" alt={id} />
            </Col>
            <Col md={6}>
              <FormGroup>
          ...
          <Row>
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <input className="form-control" type="text" name="price" id="price" ref={node => (price = node)} />
              </FormGroup>
            </Col>
          </Row>
          <Row>
