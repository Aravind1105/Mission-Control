    ...
    <React.Fragment>
      ...
      >
        <ModalBody>
          <Row>
            <Col md={6}>
              <img src={backgroundImg} className="rounded-circle width-150 height-150" alt={id} />
            </Col>
            <Col md={6}>
              <FormGroup>
          ...
          <Row>
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <input className="form-control" type="textarea" name="notes" id="notes" ref={node => (notes = node)} />
              </FormGroup>
            </Col>
          </Row>
        </ModalBody>
